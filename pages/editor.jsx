...
const Editor = () => {
    ...
    const { ee, toneCtx, uploadRef, uploadAnnRef, allbuttons, enableCut, enableSplit } = state;
    ...
    const container = useCallback(
        (node) => {
            if (node !== null && toneCtx !== null) {
                ...
                ee.on("audiosourceserror", (e) => alert(e.message + " " + "please only use type mp3"));
                // disable enable cut when a region is made
                ee.on("enableCut", (payload) =>
                    dispatch({
