...
import { AppBar, Box, Toolbar, Typography, Stack, InputBase, Tooltip, Button, IconButton } from "@mui/material";
...
export default function NavBAr() {
    ...
    async function showDemo() {
        ...
        setDialogBox(true);
        try {
            const track = "https://raw.githubusercontent.com/TareqFl/samples_data/main/Podcast.wav";
            const annotation = "https://raw.githubusercontent.com/TareqFl/samples_data/main/annotations.json";
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            ...
            >
                <Toolbar>
                    <Stack flexDirection={"row"} alignItems={"center"} justifyContent={"start"} gap={0.5}>
                        {/* <img src={wave} style={{ width: '40px' }} /> */}
                        <Bars height="80" width="80" color="#9c27b0" ariaLabel="bars-loading" visible={true} />
                        <Typography color={mode === "light" ? dark : light}>React-Studio</Typography>
                    </Stack>
